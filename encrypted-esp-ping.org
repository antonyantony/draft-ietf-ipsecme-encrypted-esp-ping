...
In addition to probing the outgoing paths, incoming traffic must also be monitored
to get a complete picture of IPsec path health. Incoming per-SA byte and packet counters maintained by IPsec are
